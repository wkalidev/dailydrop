  ...
  skills: [
    {
      ...
      tags:        ["verification", "blockchain", "sybil-resistance"],
      inputModes:  ["text"],
      outputModes: ["text"],
    },
    {
    ...
    },
    {
      ...
      tags:        ["verification", "batch", "airdrop"],
      inputModes:  ["text"],
      outputModes: ["text"],
      x402: { required: true, amount: "0.01", currency: "USDC", chain: "base" },
    },
    {
      id:          "get_leaderboard",
      name:        "Leaderboard",
